package com.gmail.shilovich.stas.jd.controller.security;

import com.gmail.shilovich.stas.jd.controller.handler.ApiAccessDeniedHandler;
...
public class ApiSecurityConfigurer extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatcher("/api/v1/private/cards/**")
                .authorizeRequests()
                .anyRequest()
